...
const Actionable = () => {
  return (
   ...
   <div className={styles.develop_child_1_div}>
        ...
        <div className="">
            <img  className={styles.develop_child_1_div_img} src="https://coschedule.com/blog/wp-content/themes/CoS4/img/academy/white-sprinkles.svg" alt="" />
        </div>
            <div className="">
    ...
    <div className={styles.develop_child_2_div}>
            ...
            <div className="">
                <img className={styles.develop_child_2_div_img2} src="https://media.coschedule.com/uploads/2020/09/Template-Academy-Pro-Squeeze-Page_header-image.png" alt="" />
            </div>
    </div>
   </div>
   </div>
   ...
   <div className={styles.industry_main_div} >
        <div className={styles.industry_child_div} >
            <div className={styles.industry_son_div} >
                <img className={styles.industry_child_div_image} src="https://media.coschedule.com/uploads/2020/09/Academy-Pro-Squeeze-Page_social-proof-1.png" alt="" />
                <h2 className={styles.industry_child_div_h2} >1,000+ lessons completed every month</h2>
            </div> 

            <div className={styles.industry_son_div} >
                <img className={styles.industry_child_div_image} src="https://media.coschedule.com/uploads/2020/09/Academy-Pro-Squeeze-Page_social-proof-2.png" alt="" />
                <h2 className={styles.industry_child_div_h2}>2 Industry-recognized Certifications</h2>
            </div> 

            <div className={styles.industry_son_div} >
                <img className={styles.industry_child_div_image} src="https://media.coschedule.com/uploads/2020/09/Academy-Pro-Squeeze-Page_social-proof-3.png" alt="" />
                <h2 className={styles.industry_child_div_h2}>100s of exclusive videos, templates, &amp; tutorials</h2>
            </div> 
   ...
   <div className={styles.improve_main_container_div}>
    ...
    <div  className={styles.improve_main_div}>
        <div className={styles.improve_child_div}>
            <h2 className={styles.improve_div_h2}>Improve your marketing with fluff-free training.</h2>
            <p><span className={styles.improve_div_spam}>Most marketing courses &amp; conferences teach you what you should do vs. how to actually do it.&nbsp;</span><span className={styles.improve_div_spam}>Why invest time or money in training if you can’t easily apply anything you learn?&nbsp;</span></p>
            <p><span className={styles.improve_div_spam}>No filler. No trend-chasing. No empty promises. Every course includes step-by-step tutorials, templates, and actionable advice you can implement to improve your marketing.</span></p>
            <p><span className={styles.improve_div_spam}>Drive better results using proven frameworks, techniques, and strategies found only in the Actionable Marketing Institute.</span></p>
        </div> 

        <div className={styles.improve_child_div}>
            <img className={styles.improve_child_div_img} src="https://media.coschedule.com/uploads/2020/09/Academy-Pro-Squeeze-Page-Graphics-05.png" alt="Person learning through the Actionable Marketing Institute"  />
        </div> 
    </div>
...
<div className={styles.Spend_container_main_div_spam}>
   <div  className={styles.Spend_main_div}>
        <div className={styles.Spend_child_div}>
            <img className={styles.Spend_child_div_img} src="https://media.coschedule.com/uploads/2020/09/Academy-Pro-Squeeze-Page-Graphics-06.png" alt="" />
        </div> 
        <div className={styles.Spend_child_div}>
            <h2 className={styles.Spend_div_h1}>Spend less time learning &amp; more time doing.</h2>
            <p><span className={styles.Spend_div_spam}>Stop scouring Google results for quality, up-to-date advice. Enroll in the Actionable Marketing Institute Pro to unlock 30+ premium courses that include everything you need to learn something new. From start to finish.&nbsp;</span></p>
            <p><span className={styles.Spend_div_spam}>Confidently put what you learn into action with courses designed to help you learn fast.</span></p>
        </div> 
    </div>
...
<div className={styles.become_container_main_div}>
   ...
   <div className="">
        <img className={styles.become_main_div_img1} src="https://coschedule.com/blog/wp-content/themes/CoS4/img/academy/black-sprinkles-half.svg" alt="" />   
        </div>
   ...
   <div className={styles.become_main_div}>
    ...
    <div className="">
        <img className={styles.become_main_div_img2} src="https://coschedule.com/blog/wp-content/themes/CoS4/img/academy/black-lines.svg" alt="" />
        </div>
   </div>
</div>
